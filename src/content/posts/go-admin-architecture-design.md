---
title: "Go 项目框架：admin_back_go 的 Gin 模块化单体落地"
published: 2026-05-03T10:00:00Z
draft: false
tags: [置顶, Go, Gin, 架构, 后端, RBAC, Redis, Queue, Docker]
description: "以 admin_back_go 为样本，复盘一个 Go Admin 后端项目框架如何组织 admin-api/admin-worker、bootstrap、server、middleware、module、infra、migration、smoke 和 Docker-first 部署。"
category: 后端技术
...
<!-- go-project-20260531-admin-go-strengthening:BEGIN -->
...
<!-- go-project-20260531-admin-go-strengthening:END -->
