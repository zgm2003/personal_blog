---
title: "从硬编码到动态管理：认证平台架构的三级缓存实战"
published: 2026-02-10T00:00:00+08:00
draft: false
tags: ["认证", "缓存", "Redis", "架构设计", "性能优化", "PHP", "Webman"]
description: "记录一次完整的认证平台重构过程：从散落在枚举和配置表中的硬编码，到数据库动态管理 + 三级缓存架构（进程内存 → Redis → MySQL），每个请求省掉 2-3 次 Redis 往返"
category: 后端技术
---
